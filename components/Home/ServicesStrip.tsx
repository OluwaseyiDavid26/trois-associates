            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <span
                    className="pointer-events-none absolute -bottom-3 -right-1 select-none font-[family-name:var(--font-display)] text-[110px] font-normal leading-none text-white/[0.03] transition-colors duration-300 group-hover:text-[#D9A441]/[0.07]"
                    aria-hidden="true"
                  >
                    {service.num}
                  </span>
                  ...
                  {/* Icon */}
                  <div className="relative flex h-11 w-11 items-center justify-center rounded-full border border-white/15 text-white/70 transition-colors duration-300 group-hover:border-[#D9A441]/60 group-hover:text-[#D9A441]">
                    <Icon className="h-[18px] w-[18px]" strokeWidth={1.75} />
                  </div>

                  {/* Text */}
                  <div className="relative mt-8">
                    <div className="mb-3 flex items-center gap-3 font-[family-name:var(--font-mono)] text-[11px] uppercase tracking-[0.15em] text-white/40">
                      {service.num}
                    ...
                    <p className="mt-3 text-[13.5px] leading-[1.65] text-white/55">
                      {service.description}
                    </p>
                  </div>
                </Link>
