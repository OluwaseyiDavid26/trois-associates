...
export default function StatsStrip() {
  return (
    <section className="relative overflow-hidden bg-[#0E1A2A] py-20">
      ...
      <div className="pointer-events-none absolute left-1/2 top-0 h-px w-24 -translate-x-1/2 bg-[#D9A441]/50" />
      ...
      >
        {stats.map((stat, i) => {
          ...
          return (
            ...
            >
              <span className="font-[family-name:var(--font-display)] text-[42px] font-semibold leading-none text-white transition-colors duration-300 group-hover:text-[#D9A441] sm:text-[52px]">
                {stat.value}
              </span>
