...
//             <span className="text-white/40">Core values /</span>
//             What we stand on
//           </div>
...
//                 <span className="h-[7px] w-[7px] shrink-0 rounded-full bg-[#D9A441] transition-transform duration-300 group-hover:scale-125" />
